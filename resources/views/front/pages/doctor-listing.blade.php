...
@section('content')
   <section id="listing-banner">
      <picture class="img-wrap">
        ...
        <img
          src="https://medanta.s3.ap-south-1.amazonaws.com/banners/October2023/u6JyySMlXNGHQESP34oHfVViZp7IJc-metaRG9jdG9yLUxpc3RpbmcuanBn-.jpg"
   ...
   <section id="doctor-list">
      <div class="main-container">
        ...
        <div class="list mt-4 mb-2">
          <div class="row">
            @for ($i = 0; $i < 30; $i++)
            <div class="col-md-6 col-xl-4 doctor-card-col" data-value="liver-transplant">
            ...
            <div class="col-md-6 col-xl-4 doctor-card-col" data-value="cancer-care">
               <div class="doctor-card">
                <div class="header">
                  <div class="doc-img">
                   <img src="{{ asset('front/img/doctor-listing/chairman.png') }}" alt="Doctor Image">
            ...
            <div class="col-md-6 col-xl-4 doctor-card-col" data-value="neuro-science">
               <div class="doctor-card">
                <div class="header">
                  <div class="doc-img">
                   <img src="{{ asset('front/img/doctor-listing/chairman.png') }}" alt="Doctor Image">
