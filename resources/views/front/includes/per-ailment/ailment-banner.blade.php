<section id="ailment-banner">
    <div class="wrapper">
        <picture class="img-wrap">
            <source media="(min-width: 768px)" srcset="{{ asset('front/img/per-ailment/banner.jpg') }}">
            <source media="(min-width: 320px)" srcset="{{ asset('front/img/per-ailment/banner.jpg') }}">
